---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/manage/organize-your-infrastrucutre-invite-your-team.md"
sidebar_label: "Organize your Infrastructure and Invite your Team"
learn_status: "Published"
learn_rel_path: "Monitor your Infrastructure"
sidebar_position: "904000"
---
...
3. _Connect nodes*_, click on **Nodes** tab. Copy the claiming script to your node and run it. See the
   [connect to Cloud doc](/docs/configuring/connect-agent-to-cloud) for details.
...
- **Incident response**  
  You can also create new War Rooms as one of the first steps in your incident response process.
   For example, you have a user-facing web app that relies on Apache Pulsar for a message queue, and one of your nodes using the [Pulsar collector](/docs/data-collection/message-brokers/pulsar) begins reporting a suspiciously low messages rate.
