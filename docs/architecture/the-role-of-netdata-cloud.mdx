...
and uses Netdata's [distributed data architecture](/docs/architecture/distributed-data-architecture) to store metrics
...
This quickstart assumes you've [installed Netdata](/docs/installing)
...
Room. You can [organize War Rooms](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#war-room-organization) in any way
you want, such as by the application type, for end-to-end application monitoring, or as an incident response tool.

Learn more about [Spaces](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces) and [War
Rooms](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms), including how to manage each, in their respective reference
documentation.
...
To [invite new users](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#invite-your-team), click on **Invite Users** in the
...
- The [Nodes tab](/docs/visualizations/nodes-tab) gives you the ability to see the status (offline or online), host details, alert status and also a short overview of some key metrics from all your nodes at a glance.
...
- The [Dashboards tab](/docs/visualizations/custom-dashboards) gives you the ability to have tailored made views of specific/targeted interfaces for your infrastructure using any number of charts from any number of nodes.
...
- The [Anomalies tab](/docs/ml-and-troubleshooting/anomaly-advisor) is dedicated to the Anomaly Advisor tool.

- The [Functions tab](/docs/visualizations/functions) gives you the ability to visualize functions that the Netdata Agent collectors are able to expose.

- The [Feed & events](/docs/visualizations/events-feed) tab lets you investigate events that occurred in the past, which is invaluable for troubleshooting.

#### Dynamic tabs

If you open a [new dashboard](/docs/visualizations/custom-dashboards), jump to a single-node dashboard, or navigate to a dedicated alert page, a new tab will open in War Room bar.
...
dashboards and charts](/docs/visualizations/netdata-charts) to get the most from all of Netdata's real-time
metrics.
...
Read more about [creating new dashboards](/docs/visualizations/custom-dashboards) for more details about the process and
...
Our [configuration basics doc](/docs/configuring/configuration) contains more information about `netdata.conf`, `edit-config`,
along with simple examples to get you familiar with editing your node's configuration.

After you've learned the basics, you should [secure your infrastructure's nodes](/docs/architecture/security-and-privacy-design) using
...
<Grid columns="2">
  <Box
    ...
    <BoxList>
      <BoxListItemRegexLink to="[](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces)" title="Spaces" />
      <BoxListItemRegexLink to="[](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms)" title="War Rooms" />
    </BoxList>
  </Box>
  <Box
    title="Dashboards">
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/visualizations/nodes-tab)" title="Nodes tab" />
      <BoxListItemRegexLink to="[](/docs/visualizations/kubernetes-visualizations)" title="Kubernetes" />
      <BoxListItemRegexLink to="[](/docs/visualizations/custom-dashboards)" title="Create new dashboards" />
    </BoxList>
  </Box>
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/alerting/notifications/netdata-cloud-notifications)" title="Alert notifications" />
    </BoxList>
  </Box>
  <Box
    title="Troubleshooting with Netdata Cloud">
    <BoxListItemRegexLink to="[](/docs/ml-and-troubleshooting/metric-correlations)" title="Metric Correlations" />
    <BoxListItemRegexLink to="[](/docs/ml-and-troubleshooting/anomaly-advisor)" title="Anomaly Advisor" />
    <BoxListItemRegexLink to="[](/docs/visualizations/events-feed)" title="Events Feed" />
  </Box>
  <Box
    ...
    <BoxList>
      ...
      <BoxListItemRegexLink to="[](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#invite-your-team)" title="Invite your team" />
      ...
      <BoxListItemRegexLink to="[](/docs/configuring/securing-netdata-agents/role-based-access-model)" title="Role-Based Access" />
...
- Spaces and War Rooms
  - [Spaces](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-spaces)
  - [War Rooms](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms)
- Dashboards
  - [Overview](/docs/monitor-your-infrastructure/home-overview-and-single-node-view)
  - [Nodes tab](/docs/visualizations/nodes-tab)
  - [Kubernetes](/docs/visualizations/kubernetes-visualizations)
  - [Create new dashboards](/docs/visualizations/custom-dashboards)
- Alerts and notifications
  - [View active alerts](https://github.com/netdata/netdata/blob/master/docs/monitor/view-active-alerts.md#netdata-cloud)
  - [Alert notifications](/docs/alerting/notifications/netdata-cloud-notifications)
- Troubleshooting with Netdata Cloud
  - [Metric Correlations](/docs/ml-and-troubleshooting/metric-correlations)
...
- Management and settings
  ...
  - [Invite your team](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#invite-your-team)
  - [Choose your Netdata Cloud theme](/docs/monitor-your-infrastructure/choose-your-netdata-cloud-theme)
  - [Role-Based Access](/docs/configuring/securing-netdata-agents/role-based-access-model)
