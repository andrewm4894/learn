...
| CentOS                   | 7.x            | x86\_64                                |                                                                                                                                                    |
| Docker                   | 19.03 or newer | x86\_64, i386, ARMv7, AArch64, POWER8+ | See our [Docker documentation](/docs/installing/docker) for more info on using Netdata on Docker |
