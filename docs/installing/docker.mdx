...
should [secure the Netdata instance](/docs/architecture/security-and-privacy-design). This
...
[HAProxy](/docs/configuring/securing-netdata-agents/reverse-proxies/haproxy) or
