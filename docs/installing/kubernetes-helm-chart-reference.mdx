...
learn_rel_path: "Installing"
sidebar_position: "212000"
---
...
<img src="https://img.shields.io/badge/Version-3.7.76-informational" alt="Version: 3.7.76"></img>

<img loading="lazy" src="https://img.shields.io/badge/AppVersion-v1.43.2-informational" alt="AppVersion: v1.43.2" class="img_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-Img-styles-module"></img>
...
**See our [install Netdata on Kubernetes](/docs/installing/kubernetes)
...
Netdata_](/docs/miscellaneous/kubernetes-monitoring-with-netdata-overview-and-visualizations), for a breakdown of all the collectors,
...
- [Bind](/docs/data-collection/dns-and-dhcp-servers/bind9)
- [CockroachDB](/docs/data-collection/database-servers/cockroachdb)
...
- [FreeRADIUS](/docs/data-collection/access-control,-authentication-and-authorization/freeradius)
- [HDFS](/docs/data-collection/storage,-mount-points-and-filesystems/filesystems/hdfs)
- [Lighttpd](/docs/data-collection/web-servers-and-web-proxies/lighttpd)
- [Logstash](/docs/data-collection/logs-servers/logstash)
- [MySQL](/docs/data-collection/database-servers/mysql-and-mariadb)
...
the [Prometheus](/docs/data-collection/apm/openmetrics-endpoints) collector.
...
- Take a look at our [Contributing Guidelines](/docs/contributing).
- This repository is under the [Netdata Code Of Conduct](/docs/contributing/community-code-of-conduct).
