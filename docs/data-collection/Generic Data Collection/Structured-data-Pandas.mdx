...
| chart_configs.family | [family](/docs/visualizations/netdata-charts#families) of the chart to be displayed in the dashboard. | None | yes |
| chart_configs.context | [context](/docs/visualizations/netdata-charts#contexts) of the chart to be displayed in the dashboard. | None | yes |
