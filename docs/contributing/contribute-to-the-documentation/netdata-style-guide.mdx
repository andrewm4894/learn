...
learn_rel_path: "Contributing/Contribute to the documentation"
...
> ### Note
> This document is meant to be accompanied by the [Documentation Guidelines](/docs/contributing/contribute-to-the-documentation). If you want to contribute to Netdata's documentation, please read it too.
...
|                 |                                                                                                                                         |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Not recommended | To install Netdata, click [here](/docs/installing).                         |
| **Recommended** | To install Netdata, read the [installation instructions](/docs/installing). |
...
For example, the [configuration](/docs/configuring/configuration) doc first
...
| **Recommended** | Use `edit-config` to edit Netdata's configuration by first navigating to your [Netdata config directory](/docs/configuring/configuration#the-netdata-config-directory), which is typically at `/etc/netdata`, then running `sudo edit-config netdata.conf`. |
...
| Term                        | Definition                                                                                                                                                                                                                                                                                                                                                                                                            |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **claimed node**            | A node that you've proved ownership of by completing the [connecting to Cloud process](/docs/configuring/connect-agent-to-cloud). The claimed node will then appear in your Space and any War Rooms you added it to.                                                                                                                                                                            |
...
| **unreachable node**        | A connected node with a disrupted [Agent-Cloud link](/docs/configuring/securing-netdata-agents/agent-cloud-link-aclk). Unreachable could mean the node no longer exists or is experiencing network connectivity issues with Cloud.                                                                                                                                                                                      |
