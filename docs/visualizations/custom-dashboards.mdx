---
custom_edit_url: "https://github.com/netdata/netdata/edit/master/docs/cloud/visualize/dashboards.md"
...
node. Next, select the context. You'll see a preview of the chart before you finish adding it. In this modal you can also [interact with the chart](/docs/visualizations/netdata-charts), meaning you can configure all the aspects of the [NIDL framework](/docs/visualizations/netdata-charts#nidl-framework) of the chart and more in detail, you can:
  ...
  After you are done configuring the chart, you can also change the type of the chart from the right hand side of the [Title bar](/docs/visualizations/netdata-charts#title-bar), and select which of the final dimensions you want to be visible and in what order, from the [Dimensions bar](/docs/visualizations/netdata-charts#dimensions-bar).
...
The charts you add to any dashboard are [fully interactive](/docs/visualizations/netdata-charts), just like any other Netdata chart. You can zoom in and out, highlight timeframes, and more.

Charts also synchronize as you interact with them, even across contexts _or_ nodes.

### Text cards

You can use text cards as notes to explain to other members of the [War Room](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#netdata-cloud-war-rooms) the purpose of the dashboard's arrangement. 
...
to [invite your team](/docs/monitor-your-infrastructure/organize-your-infrastructure-and-invite-your-team#invite-your-team) if
